...
<div class="max-w-[1200px] w-full mx-auto pb-10">
    ...
    <div class="mb-8 text-center pt-2">
        <h1 class="text-[28px] font-bold text-gray-800">Kanban Board</h1>
    </div>
    ...
    <div class="flex flex-row overflow-x-auto gap-6 pb-6 custom-scrollbar min-h-[400px] items-start">
        ...
        @endphp
        <!-- Board Column -->
        <div class="bg-gradient-to-b from-blue-50 to-indigo-100 border border-indigo-200 w-[360px] min-w-[360px] rounded-3xl p-5 shadow-sm flex flex-col shrink-0">
            ...
            <div class="flex flex-col gap-3 flex-1 px-1">
                ...
                <div class="bg-white border border-white/50 rounded-2xl px-5 py-4 shadow-sm hover:shadow-md hover:scale-[1.02] transition-all duration-300 group">
                    <div class="text-[13px] text-gray-800 font-bold mb-2">{{ $task->title }}</div>
                    <div class="flex justify-between items-center text-gray-800 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                ...
                <!-- New Task Form -->
                <div class="bg-white border border-gray-200 rounded-xl px-4 py-2.5 shadow mt-auto mb-1 transition duration-200 hover:shadow-md focus-within:shadow-md">
            ...
            <div class="flex justify-between items-center mt-3 px-1 text-gray-800">
                <div class="flex gap-2">
    ...
    <div class="flex justify-center mt-8">
        <button onclick="document.getElementById('boardModal').classList.remove('hidden')" class="bg-white border-2 border-dashed border-gray-300 hover:border-indigo-400 hover:bg-indigo-50/50 hover:scale-[1.02] text-gray-500 hover:text-indigo-600 font-bold px-10 py-8 rounded-3xl transition-all duration-300 shadow-sm w-full max-w-[400px] flex flex-col items-center justify-center gap-3 group">
            <div class="bg-gray-100 w-12 h-12 rounded-full flex items-center justify-center group-hover:bg-indigo-100 transition">
                <i class="fas fa-plus text-xl text-gray-400 group-hover:text-indigo-500"></i>
            </div>
